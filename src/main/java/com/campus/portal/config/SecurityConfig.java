...
import com.campus.portal.security.JwtAuthFilter;
import com.campus.portal.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**", "/api/departments", "/api/categories").permitAll()
